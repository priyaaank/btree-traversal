...
public class PostOrderTraversalStrategy<T extends Comparable> extends TraversalStrategy<T> implements Constants.LogMessages {
    ...
    public void visit(final T value, final TreeNode<T> leftNode, final TreeNode<T> rightNode) {
        ...
        LogFactory.getLoggerInstance().log(Level.INFO, String.format(INFO_POST_ORDER_SCANNING, value));
